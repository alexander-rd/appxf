...
from appxf_private.gui.setting_dict import SettingDictSingleFrame, SettingDictColumnFrame
...
class RegistrationAdmin:
    ...
    def _load_request_ui(self, request_bytes: bytes):
        ...
        '''
        from appxf_private.registry._registration_request import RegistrationRequest
