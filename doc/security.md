...
operating system and stolen data cannot be used without this password. A
**registration** procedure can ensure that only authorized users get access to
servers. For example can you verify the requested user role and you can provide
server passwords as part of the registration process.

Usage can be as simple as the following. Note that login and registration both
